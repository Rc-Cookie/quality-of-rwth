...
function linkAction(url, ctrlKey, shiftKey, flip = false) {
    const canOpenEmbeddedTab = true; // Chrome: const canOpenEmbeddedTab = false; // TODO: Chrome popups don't support loading a website into the popup - at least not out of the box
